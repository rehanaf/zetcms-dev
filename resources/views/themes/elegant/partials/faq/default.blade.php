                ...
                <div class="col-lg-8">
                    <div class="accordion" id="faqAccordion">
                        @foreach($data['faqs'] as $i => $faq)
                            <div class="accordion-item border-0 mb-3 rounded shadow-sm bg-cream">
                                <h2 class="accordion-header" id="heading{{ $i }}">
                                    <button class="accordion-button collapsed bg-transparent font-serif text-chocolate fw-bold fs-5 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $i }}" aria-expanded="false" aria-controls="collapse{{ $i }}">
                                        {{ $faq['question'] }}
                                    </button>
                                </h2>
