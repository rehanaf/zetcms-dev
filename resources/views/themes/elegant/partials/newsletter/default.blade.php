...
--}}
<section class="py-5 bg-chocolate text-white">
    <div class="container py-5 text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                @if(!empty($data['title']))
                    <h2 class="display-6 font-serif text-accent mb-3">{{ $data['title'] }}</h2>
                @endif
                ...
                <form action="{{ route('newsletter.subscribe') }}" method="POST">
                    ...
                    <div class="input-group mb-3 shadow-lg">
                        ...
                        <button class="btn btn-elegant py-3 px-4" type="submit">
