...
--}}
<section class="py-5 position-relative overflow-hidden bg-chocolate-dark" style="border-top: 2px solid var(--color-accent); border-bottom: 2px solid var(--color-accent);">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                @if(!empty($data['subtitle']))
                    <p class="text-accent fw-bold m-0 mb-3" style="letter-spacing: 3px; font-size: 0.9rem;">
                        {{ $data['subtitle'] }}
                    </p>
                @endif
                ...
                @if(!empty($data['button_text']))
                    <a href="{{ $data['button_url'] ?? '#' }}" class="btn-elegant px-5 py-3 fs-5 shadow-lg">
                        {{ $data['button_text'] }}
                    </a>
                @endif
            </div>
