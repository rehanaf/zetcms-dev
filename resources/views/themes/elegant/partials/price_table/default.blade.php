...
--}}
<section class="py-5 bg-cream" id="menu">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 150 }}">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            @elseif(!empty($category['icon']))
                                <div class="text-accent fs-3 me-3"><i class="{{ $category['icon'] }}"></i></div>
                            @endif
                            
                            <h3 class="font-serif text-chocolate m-0">{{ $category['title'] ?? '' }}</h3>
                        </div>
                            ...
                            <div class="d-flex flex-column">
                                @foreach($category['items'] as $item)
                                    <div class="menu-item-box d-flex justify-content-between align-items-center mt-3">
                                        <div class="pe-3">
                                            <h5 class="fw-bold m-0 text-chocolate">{{ $item['name'] ?? '' }}</h5>
