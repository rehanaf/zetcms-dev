...
<section class="py-5 bg-cream">
    <div class="container py-4">
        ...
        <div class="text-center mb-5 pb-3 border-bottom border-accent border-opacity-25">
            <h1 class="display-4 font-serif text-chocolate fw-bold mb-3">Jurnal & Berita</h1>
            ...
            <div class="col-lg-8">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5 p-4 bg-white rounded shadow-sm border border-accent border-opacity-25">
                    <form action="{{ route('blog.index') }}" method="GET" class="w-100" style="max-width: 400px;">
                        <div class="input-group">
                            <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari jurnal..." class="form-control rounded-start bg-cream border-0 focus-ring-accent" style="box-shadow: none;">
                            <button type="submit" class="btn btn-elegant"><i class="fa-solid fa-search"></i></button>
                        </div>
                    </form>
                ...
                @if($posts->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <h4 class="font-serif text-chocolate">Tidak ada tulisan ditemukan</h4>
                                    ...
                                    <div class="card-footer bg-transparent border-0 p-0 mt-auto">
                                        <div class="d-flex align-items-center justify-content-between pt-3 border-top border-accent border-opacity-25">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded-circle bg-chocolate-dark text-accent d-flex justify-content-center align-items-center fw-bold" style="width: 30px; height: 30px; font-size: 0.8rem;">
                ...
                <div class="position-sticky" style="top: 100px;">
                    ...
                    <div class="card bg-white border-0 shadow-sm rounded mb-4">
                        <div class="card-body p-4">
                            <h4 class="font-serif text-chocolate fs-5 mb-4 border-bottom border-accent border-opacity-25 pb-2">Kategori Tulisan</h4>
